...
allQMRA_forsummary = allQMRA_forsummary %>%
    pivot_longer(cols = starts_with("endpoint_value"),
                 names_to = "info_setting",
                 values_to = "endpoint_value",
                 names_prefix = "endpoint_value_")
...
summarytable_output %>%
    # Wrangle data
    ungroup() %>%
    dplyr::select(-c(n, info_organism, info_setting, info_treatmenttype)) %>%
