...
Pinf_trip = function(Pinf, plotsdisp) {
    ...
    if (plotsdisp == TRUE) {
        summ_Pinftrip = summstats(Pinf_trip)  
        print(summ_Pinftrip)
...
Pinf_campy_trip = Pinf_trip(Pinf = Pinf_campy, plotsdisp = plotsdisp)  # Probability of infection with Campylobacter for a 7-day backpacking trip
Pinf_giardia_trip = Pinf_trip(Pinf = Pinf_giardia, plotsdisp = plotsdisp)  # Probability of infection with Campylobacter for a 7-day backpacking trip
